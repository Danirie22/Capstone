...
const menuItems = [
  {
    name: "Espresso",
    description:
      "A strong, concentrated coffee brewed by forcing a small amount of nearly boiling water through finely-ground coffee beans.",
    price: "$2.50",
    image: image3,
  },
  {
    name: "Latte",
    description:
      "A coffee drink made with espresso and steamed milk, topped with a thin layer of foam.",
    price: "$4.00",
    image: image4,
  },
  {
...
function MenuLoggedIn() {
  ...
  return (
    <main className="menu-content">
      <h1 className="menu-title">Our Menu (Logged In)</h1>
